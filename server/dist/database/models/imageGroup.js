...
module.exports = function (sequelize, DataTypes) {
    var imageGroup = sequelize.define('imageGroup', {
        id: {
            primaryKey: true,
            type: DataTypes.UUID,
     ...
     */
    imageGroup.list = function (_a) {
        var page = _a.page, limit = _a.limit, imageId = _a.imageId, groupId = _a.groupId;
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    return [2 /*return*/, imageGroup.findAndCountAll(getAllOptions)];
                }
                catch (error) {
                    throw {
     ...
     * @throws error if query fails
     */
    imageGroup.get = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var item, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, imageGroup.findOne({
                            where: {
                                id: id
                            }
                        })];
     ...
     * @throws error if query fails
     */
    imageGroup.deleteAll = function (_a) {
        var imageId = _a.imageId, groupId = _a.groupId;
        return __awaiter(_this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_b) {
                try {
                    ...
                    return [2 /*return*/, imageGroup.destroy({
                            where: options
                        })];
                }
                catch (error) {
