...
module.exports = function (sequelize, DataTypes) {
     ...
     */
    group.list = function (_a) {
        var page = _a.page, limit = _a.limit, thumbnailUrl = _a.thumbnailUrl, imageUrl = _a.imageUrl, title = _a.title, description = _a.description;
        return __awaiter(_this, void 0, void 0, function () {
            var options, getAllOptions;
            return __generator(this, function (_b) {
                try {
                    options = omitBy({
                        thumbnailUrl: thumbnailUrl, imageUrl: imageUrl, title: title, description: description
                    }, isNil);
                    getAllOptions = {
                        where: options
                    };
                    ...
                    return [2 /*return*/, group.findAndCountAll(getAllOptions)];
                }
                catch (error) {
                    throw {
     ...
     * @throws error if query fails
     */
    group.get = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var item, error_1;
     ...
     * @throws error if query fails
     */
    group.deleteAll = function (_a) {
        var thumbnailUrl = _a.thumbnailUrl, imageUrl = _a.imageUrl, title = _a.title, description = _a.description;
        return __awaiter(_this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_b) {
                try {
