...
module.exports = function (sequelize, DataTypes) {
     ...
     */
    image.list = function (_a) {
        var page = _a.page, limit = _a.limit, thumbnailUrl = _a.thumbnailUrl, imageUrl = _a.imageUrl, title = _a.title, description = _a.description, location = _a.location;
        return __awaiter(_this, void 0, void 0, function () {
            var options, getAllOptions;
            return __generator(this, function (_b) {
                try {
                    options = omitBy({
                        thumbnailUrl: thumbnailUrl, imageUrl: imageUrl, title: title, description: description, location: location
                    }, isNil);
                    getAllOptions = {
                        where: options
                    };
                    ...
                    return [2 /*return*/, image.findAndCountAll(getAllOptions)];
                }
                catch (error) {
                    throw {
     ...
     * @throws error if query fails
     */
    image.get = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var item, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, image.findOne({
                            where: {
                                id: id
                            }
                        })];
     ...
     * @throws error if query fails
     */
    image.deleteAll = function (_a) {
        var thumbnailUrl = _a.thumbnailUrl, imageUrl = _a.imageUrl, title = _a.title, description = _a.description, location = _a.location;
        return __awaiter(_this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_b) {
                try {
