...
module.exports = function (sequelize, DataTypes) {
     ...
     */
    tag.list = function (_a) {
        var page = _a.page, limit = _a.limit, title = _a.title;
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                try {
                    ...
                    return [2 /*return*/, tag.findAndCountAll(getAllOptions)];
                }
                catch (error) {
                    throw {
     ...
     * @throws error if query fails
     */
    tag.get = function (id) { return __awaiter(_this, void 0, void 0, function () {
        var item, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, tag.findOne({
                            where: {
                                id: id
                            }
                        })];
