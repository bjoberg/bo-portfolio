...
var SequelizeController = /** @class */ (function () {
    ...
    function SequelizeController(model) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model.list(req.query)];
                    case 1:
                        data = _a.sent();
                        entityList = {
                            count: data.count,
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        // @ts-ignore
                        _b = (_a = res).json;
                        return [4 /*yield*/, this.model.get(req.params.id)];
                    case 1:
                        // @ts-ignore
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.create(req.body)];
                    case 1:
                        item = _a.sent();
        ...
        this.update = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.update(req.body, {
        ...
        this.delete = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.destroy({
                                // @ts-ignore
                                where: {
                                    id: req.params.id
                                }
         ...
         */
        this.deleteAll = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var result, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.model.deleteAll(req.query)];
                    case 1:
                        result = _a.sent();
                        res.status(http_status_1.default.OK);
                        res.json(result);
        ...
        this.model = model;
        this.sequelizeHelpers = new sequelize_helpers_1.default();
    }
    return SequelizeController;
}());
exports.default = SequelizeController;
