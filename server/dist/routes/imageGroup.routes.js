...
var imageGroup = require('../database/models').imageGroup;
var imageGroupRouter = express_1.Router();
var controller = new sequelize_controller_1.default(imageGroup);
...
exports.default = imageGroupRouter;
