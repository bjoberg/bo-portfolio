...
var imageTag = require('../database/models').imageTag;
var imageTagRouter = express_1.Router();
var controller = new sequelize_controller_1.default(imageTag);
...
exports.default = imageTagRouter;
